	...
	def resourceOffers(self, driver, offers):
		...
		for offer in offers:
			...
			if self.launched_task == 0:
				...
				if num == 0:
					args.append('--default-target=http://192.0.2.100:8888')
				elif num == 1:
					args.append('--default-target=http://192.168.199.109:8888')
				else:
					args.append('--default-target=http://192.168.199.110:8888')

				args.append('--ip=192.168.199.108')
				...
				ip = Dict()
				ip.key = 'ip'
				ip.value = '192.0.2.10' + str(self.launched_task)
