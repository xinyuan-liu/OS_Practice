...
class MinimalScheduler(Scheduler):
    ...
    def __init__(self, executor):
        ...
        self.finished_num = 0
        self.result=0
        self.data=['wordcount','word count','w o r d c o u n t','wo rd co unt',' w o r d c o u n t ']
    ...
    def resourceOffers(self, driver, offers):
        ...
        for offer in offers:
            ...
            task.data = encode_data(self.data[self.launched_num].format(task_id))
            self.launched_num += 1
    ...
    def statusUpdate(self, driver, update):
        ...
        if update.state == 'TASK_FINISHED':
			self.finished_num += 1
			if self.finished_num == self.task_num:
				self.output()
